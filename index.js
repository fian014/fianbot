...
*/
const BotName = 'Patrick BOT'; // Nama Bot Whatsapp
const instagramlu = 'https://www.instagram.com/fian_014'; // Nama Instagramlu cok
const whatsapplu = 'Wa.me/+6285704617188'; // Nomor whatsapplu cok
const kapanbotaktif = 'Gak Pasti'; // Kapan bot lu aktif
const grupch1 = 'Males'; // OFFICIAL GRUP LU 1
const grupch2 = 'Bikin'; // OFFICIAL GRUP LU 2
const grupch3 = 'Grub'; // OFFICIAL GRUP LU 3
//
